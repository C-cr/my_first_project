module my_first_project::testnet_nft;
...
public fun mint_to_sender(
    ...
    let nft = TestnetNFT {
        id: object::new(ctx),
        name: string::utf8(b"kudoxiyiji"),
        description: string::utf8(b"This is my first NFT"),
        url: url::new_unsafe_from_bytes(b"https://tse3.mm.bing.net/th/id/OIP.nTg06kvTEDXJwaA9QoHvPwHaHa?rs=1&pid=ImgDetMain&o=7&rm=3"),
    };
